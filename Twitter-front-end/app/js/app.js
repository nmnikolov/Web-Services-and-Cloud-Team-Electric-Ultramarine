var app = angular.module('TwitterApp', ['ngAnimate', 'ngRoute', 'ngResource', 'infinite-scroll', 'ui.bootstrap', 'angularSpinner', 'rt.popup']);
...
app.constant({
    'BASE_URL':'http://twitter-ultramarine.azurewebsites.net/api/',
